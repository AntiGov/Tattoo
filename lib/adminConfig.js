  ...
  collections: {
    ...
    AppSettings: {
    	tableColumns: [
	   		...
	   		{ label: 'User Email', name: "userEmail()" },
	   		{ label: 'Location', name: 'appLocationName()'},
	   		{ label: 'Style', name: 'appStyleName()'},
	   		{ label: 'User Id', name: "userId"},
	   		{ label: "app locationId", name: "appLocationId"},
	   		{ label: "app styleId", name: "styleId"}
  		]
    },
    AppLocations: {
    	tableColumns: [
